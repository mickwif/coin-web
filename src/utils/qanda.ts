...
export const qanda: QA[] = [
  ...
  {
    question: 'WHAT IS YZY CARD',
    answer: 'YZY CARD IS A TOOL FOR SPENDING YZY AND USDC GLOBALLY',
  },
  {
  ...
  },
  {
    ...
    answer: `<div>
      <ul>
        <li>INSTALL THE MOONSHOT APP FROM THE <a href="https://moonshot.com" target="_blank">APP STORE</a> OR <a href="https://moonshot.com" target="_blank">GOOGLE PLAY</a></li>
  ...
  },
  {
    ...
    answer: `<p>25 CONTRACT ADDRESSES FOR THE YZY HAVE BEEN DEPLOYED, WITH ONE SELECTED AT RANDOM FOR THE OFFICIAL YZY. THIS DISSUADES SNIPERS BY MAKING IT A 1/25 CHANCE FOR SELECTION OF THE RIGHT CA, PUTTING POWER BACK INTO THE HANDS OF REAL TRADERS</p>`,
  },
  {
    question: 'WHAT BLOCKCHAIN ARE YZY MINTED ON',
    answer:
      '<p>ALL YZY ARE MINTED ON THE SOLANA BLOCKCHAIN</p>',
  },
  {
...
<a href="${process.env.NEXT_PUBLIC_TRANCHE_3E}">3E</a>
  ...
  },
  {
    ...
    answer: `<p>PLEASE REVIEW IMPORTANT DISCLOSURES REGARDING YZY <a href="/terms" class="">HERE</a></p>`,
  },
];