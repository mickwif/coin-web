...
export const qanda: QA[] = [
  ...
  },
  {
    ...
    answer: 'YEEZY MONEY IS A SUITE OF FINANCIAL SERVICES DESIGNED FOR THE FUTURE ONCHAIN ECONOMY. YEEZY MONEY CONSISTS OF THE YZY, YE PAY, AND YZY CARD. YEEZY MONEY IS BUILT FOR BUSINESSES AND INDIVIDUALS THAT WANT TO UNLOCK THE BENEFITS OF CRYPTO ENABLED PAYMENTS AND FINANCIAL RAILS',
  },
  {
  ...
  },
  {
    ...
    answer: 'YEEZY MONEY DEBIT CARDS ARE FINANCIAL INSTRUMENTS FOR SPENDING YZY AND USDC GLOBALLY',
  },
  {
